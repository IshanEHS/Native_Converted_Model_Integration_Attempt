...
import com.native_model_integration_attempt.tokenization.FullTokenizer;
...
public final class FeatureConverter {
  ...
  public FeatureConverter(
    ...
    this.tokenizer = new FullTokenizer(inputDic, false);
    this.maxQueryLen = maxQueryLen;
    this.maxSeqLen = maxSeqLen;
  }

  public Feature convert(String context) {
